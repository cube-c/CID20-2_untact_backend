    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='exhibition.position')),
            ],
        ),
        migrations.CreateModel(
            name='UserWithTitle',
            fields=[
                ...
                ('status', models.CharField(choices=[('online', 'Online'), ('offline', 'Offline'), ('dnd', 'Dnd')], default='offline', max_length=7)),
